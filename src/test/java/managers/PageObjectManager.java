...
public class PageObjectManager {
	 ...
	 return (productRelaysMainPage == null) ? productRelaysMainPage = new ProductRelaysMainPage(driver) : productRelaysMainPage;	 
	 }
	 
	 public ProductReedRelaysPage getProductReedRelaysPage(){	 
	 return (productReedRelaysPage == null) ? productReedRelaysPage = new ProductReedRelaysPage(driver) : productReedRelaysPage;	 
	 }
